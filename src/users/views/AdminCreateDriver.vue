...
const submitForm = async () => {
  ...
  try {
    ...
    form.value = { email: '', password: '', name: '', phone: '', vehicle: ''}
    router.push('/users')
  } catch (error) {
  ...
  <div class="min-h-screen bg-gray-50 p-4 md:p-8">
    <div class="max-w-2xl mx-auto">
      ...
      <form @submit.prevent="submitForm" class="bg-white rounded-lg shadow p-6 space-y-6">
        ...
        <div>
          <label for="vehicle" class="block text-sm font-medium text-gray-700 mb-2">Vehiculo a utilizar</label>
          <input
